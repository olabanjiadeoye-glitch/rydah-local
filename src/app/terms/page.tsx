      ...
      <article className="mx-auto max-w-3xl">
        ...
        <div className="mt-6 space-y-8 text-sm leading-7 text-zinc-300">
          ...
          <section>
            ...
            <p className="mt-2">The standard provider price is a one-time ₦500 registration fee and a ₦500 monthly provider subscription. Rydah&apos;s Founding 100 promotion reserves 40 places for Lagos and 15 places each for Abuja/FCT, Ibadan/Oyo, Warri/Delta and Port Harcourt/Rivers. A provider whose promotional place is confirmed in the app receives a permanently waived registration fee and three months of free provider marketplace access. After the free period ends, the normal ₦500 monthly subscription becomes required. Providers outside the available promotional allocation follow the standard registration and monthly billing rules from the start.</p>
            <p className="mt-2">The monthly subscription is collected through an approved Nigerian bank Direct Debit mandate where supported by the provider&apos;s bank. Providers must keep either an active Founding 100 free period or an active monthly subscription to remain available for new Rydah jobs. If the free period ends without subscription activation, or a recurring debit fails, is revoked, or becomes inactive, Rydah may take the provider profile offline until billing is restored.</p>
