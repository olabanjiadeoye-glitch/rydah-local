  ...
  return (
    <main className="min-h-screen bg-[#080808] px-5 py-8 text-white">
      <section className="mx-auto max-w-6xl">
        ...
        {loading ? (
          <div className="mt-6 rounded-3xl border border-white/10 bg-[#121212] p-7 text-zinc-400">Loading safety reports…</div>
        ) : visibleRows.length === 0 ? (
          <div className="mt-6 rounded-3xl border border-white/10 bg-[#121212] p-7 text-zinc-400">No safety reports in this view.</div>
        ) : (
